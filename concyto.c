...
#define nrn_init _nrn_init__concyto
#define _nrn_initial _nrn_initial__concyto
#define nrn_cur _nrn_cur__concyto
#define _nrn_current _nrn_current__concyto
#define nrn_jacob _nrn_jacob__concyto
#define nrn_state _nrn_state__concyto
#define _net_receive _net_receive__concyto 
#define states states__concyto 
...
extern Memb_func* memb_func;
 ...
 "setdata_concyto", _hoc_setdata,
 "J_leak_concyto", _hoc_J_leak,
 0, 0
};
#define J_leak J_leak_concyto
 extern double J_leak( _threadargsprotocomma_ double , double );
 /* declare global and static user variables */
#define F F_concyto
 double F = 96.4846;
#define P_cyto P_cyto_concyto
 double P_cyto = 0.7;
#define corrfactor corrfactor_concyto
 double corrfactor = 10;
#define fc fc_concyto
 double fc = 0.01;
 ...
 "F_concyto", &F_concyto,
 "P_cyto_concyto", &P_cyto_concyto,
 "fc_concyto", &fc_concyto,
 "corrfactor_concyto", &corrfactor_concyto,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 concyto C:/Users/sourabh/Desktop/Single-cell/concyto.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcai = fc * ( ( ( ( - corrfactor * ica * a ) / ( 2.0 * F * Vol * P_cyto ) ) ) + J_leak ( _threadargscomma_ capui , cai ) ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 Dcai = Dcai  / (1. - dt*( (( fc * ( ( ( ( - corrfactor * ica * a ) / ( 2.0 * F * Vol * P_cyto ) ) ) + J_leak ( _threadargscomma_ capui , ( cai  + .001) ) ) ) - ( fc * ( ( ( ( - corrfactor * ica * a ) / ( 2.0 * F * Vol * P_cyto ) ) ) + J_leak ( _threadargscomma_ capui , cai ) )  )) / .001 )) ;
 return 0;
}
 /*END CVODE*/
